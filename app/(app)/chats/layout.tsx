...
export default async function ChatLayout({
  ...
  return (
    <div className="flex h-full w-full border rounded-lg overflow-hidden bg-muted/5">
      <RecentChats className="w-full max-w-sm border-r" contacts={contactsWithLastMessageJSON} />
