 ...
 * @description A TikTok icon component compatible with Tailwind CSS.
 * @param {SocialIconProps} props - The props for the TikTok icon.
 * @returns {JSX.Element} The TikTok icon SVG.
 */
const TiktokIcon = ({
    size = undefined,
    color = 'currentColor',
